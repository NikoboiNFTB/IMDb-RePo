    ...
    function createWatchButton(type) {
        ...
        if (type === 'TV') {
            ...
            [seasonInput, episodeInput].forEach((inp, i) => {
                inp.type = 'number';
                inp.min = '1';
                inp.placeholder = i ? 'Episode' : 'Season'; // placeholders
                inp.style.cssText = `
            width:72px;
            height:28px;
            border-radius:4px;
        ...
        `;
            ...
            inputsWrapper.style.gap = '8px'; // gap between season & episode inputs
            inputsWrapper.style.marginLeft = '36px'; // **big gap from "Watch" label**
